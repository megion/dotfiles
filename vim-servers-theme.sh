...
for instance in $(vim --serverlist); do
    ...
    if [ $scheme == "dark" ]; then
        ...
        vim --servername $instance --remote-send $'\e:highlight CocFloating ctermbg=8\n'
        vim --servername $instance --remote-send $'\e:autocmd ColorScheme * hi CocFloating ctermbg=8\n'

        vim --servername $instance --remote-send $'\e:highlight CocMenuSel ctermbg=0\n'
        vim --servername $instance --remote-send $'\e:autocmd ColorScheme * hi CocMenuSel ctermbg=0\n'
        ...
        vim --servername $instance --remote-send $'\e:highlight CocFloating ctermbg=15\n'
        vim --servername $instance --remote-send $'\e:autocmd ColorScheme * hi CocFloating ctermbg=15\n'

        vim --servername $instance --remote-send $'\e:highlight CocMenuSel ctermbg=7\n'
        vim --servername $instance --remote-send $'\e:autocmd ColorScheme * hi CocMenuSel ctermbg=7\n'
